...
var fileType ;
var fileTypeSimple;
var submit_mark = false;
function intializePage(fileUrl)
{
	OFFICE_CONTROL_OBJ = document.all("TANGER_OCX");
	OFFICE_CONTROL_OBJ.AddDocTypePlugin(".pdf","PDF.NtkoDocument","4.0.0.0","ntkopdfdoc.cab",51,true);	
...
function saveFileToUrl()
{
	...
	document.getElementById('operate').value = 'updateWjNr';
