...
document.write('codebase="officecontrol/OfficeControl.cab#version=5,0,1,8" width="100%" height="100%">   ');
...
document.write('<param name="Caption" value="在线文档控件(双击全屏显示)">   ');
document.write('<param name="ProductCaption" value="株洲南车时代电气股份有限公司"> ');
document.write('<param name="ProductKey" value="76D714B107F2FE517A9B3370AE6CF0A80509E2DD">');
