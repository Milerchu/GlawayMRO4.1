...
dojo.provide("layers.mbs.startcenter");
		...
		*/
		defaultParams: {
			...
			htmlLabels:  true,		// use HTML to draw labels
 	                breakSpacing:10,		// spacing for axis break 
			breakAt:	 null		// specify axis break range,used with "vertical": {from:xx,to:xx}  
		},
		optionalParams: {
			min:			0,	// minimal value on this axis
			max:			1,	// maximal value on this axis
		...
		constructor: function(chart, kwArgs){
			...
			du.updateWithObject(this.opt, kwArgs);
			du.updateWithPattern(this.opt, kwArgs, this.optionalParams);
			// re-calculate labels if there is break on vertical axis
						if(!(this.vertical&&this.opt.breakAt) || (this.opt.breakAt.from >= this.opt.breakAt.to)){
							this.opt.breakAt = null
						}else{
			                this.opt.labelFunc = this.recalculateLabel
			}
		},
		recalculateLabel: function(value){
					value = parseFloat(value);
					var breakAt = this.breakAt;
					value = (value <= breakAt.from) ? value : ((value < breakAt.from + this.breakSpacing) ? 
					"" : value - this.breakSpacing + breakAt.to - breakAt.from)
					return value;
		},
		getOffsets: function(){
			//	summary:
...
if(!dojo._hasResource["ibm.tivoli.mbs.dijit.KpiGauge"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["ibm.tivoli.mbs.dijit.KpiGauge"] = true;
/*
...
if(!dojo._hasResource['ibm.tivoli.mbs.dijit.gauge.KpiArcRange']){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource['ibm.tivoli.mbs.dijit.gauge.KpiArcRange'] = true;
/*
 * Licensed Materials - Property of IBM
 * 
 * 5724-U18
...
dojo.i18n._preloadLocalizations("layers.mbs.nls.startcenter", ["ROOT","ar","ca","cs","da","de","de-de","el","en","en-gb","en-us","es","es-es","fi","fi-fi","fr","fr-fr","he","he-il","hu","it","it-it","ja","ja-jp","ko","ko-kr","nb","nl","nl-nl","pl","pt","pt-br","pt-pt","ru","sk","sl","sv","th","tr","xx","zh","zh-cn","zh-tw"]);
