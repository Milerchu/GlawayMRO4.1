...
;(function($) {
	$.fn.layout = function (opts) {
		...
		,	defaults: { // default options for 'all panes' - will be overridden by 'per-pane settings'
			...
			,	spacing_closed:			16			// ditto - when pane is 'closed'
			,	togglerLength_open:		50			// Length = WIDTH of toggler button on north/south edges - HEIGHT on east/west edges
			,	togglerLength_closed: 	28			// 100% OR -1 means 'full height/width of resizer bar' - 0 means 'hidden'
