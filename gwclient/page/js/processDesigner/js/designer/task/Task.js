draw2d.Task = function(configPropCallback) {
	...
	this.rightOutputPort_1 = null;
	this.rightOutputPort_2 = null;
	this.bottomOutputPort = null;
	this.bottomOutputPort_1 = null;
	this.bottomOutputPort_2 = null;
	this.topOutputPort = null;
	this.topOutputPort_1 = null;
	this.topOutputPort_2 = null;
	this.leftOutputPort = null;
	this.leftOutputPort_1 = null;
	this.leftOutputPort_2 = null;
...
draw2d.Task.prototype.createHTMLElement = function() {
	...
	this.top_left.style.height = (this.cornerHeight+5) + "px";
	...
	this.top_right.style.height = (this.cornerHeight+5) + "px";
	...
	this.header.style.height = (this.cornerHeight+5) + "px";
...
draw2d.Task.prototype.setDimension = function(w, h) {
	try{
		...
		if (this.rightOutputPort_1 !== null) {
			this.rightOutputPort_1.setPosition(this.width + 5, (this.height / 2) - 20);
		}
		if (this.bottomOutputPort_1 !== null) {
			this.bottomOutputPort_1.setPosition((this.width/2) - 20, this.height + 5);
		}
		if (this.leftOutputPort_1 !== null) {
			this.leftOutputPort_1.setPosition(-5, (this.height / 2) - 20);
		}
		if (this.topOutputPort_1 !== null) {
			this.topOutputPort_1.setPosition((this.width/2) - 20, -5);
		}
		
		if (this.rightOutputPort_2 !== null) {
			this.rightOutputPort_2.setPosition(this.width + 5, (this.height / 2) + 20);
		}
		if (this.bottomOutputPort_2 !== null) {
			this.bottomOutputPort_2.setPosition((this.width/2) + 20, this.height + 5);
		}
		if (this.leftOutputPort_2 !== null) {
			this.leftOutputPort_2.setPosition(-5, (this.height / 2) + 20);
		}
		if (this.topOutputPort_2 !== null) {
			this.topOutputPort_2.setPosition((this.width/2) + 20, -5);
		}
	}catch(e){
	}
};
...
draw2d.Task.prototype.setWorkflow = function(_5019) {
	...
	if (_5019 !== null && this.leftOutputPort === null) {
		this.topOutputPort_1 = new draw2d.MyOutputPort();
		this.topOutputPort_1.setWorkflow(_5019);
		this.topOutputPort_1.setName("topOutputPort_1");
		this.addPort(this.topOutputPort_1, (this.width/2)-20, -5);
		...
		this.topOutputPort_2 = new draw2d.MyOutputPort();
		this.topOutputPort_2.setWorkflow(_5019);
		this.topOutputPort_2.setName("topOutputPort_2");
		this.addPort(this.topOutputPort_2, (this.width/2)+20, -5);
		
		this.rightOutputPort_1 = new draw2d.MyOutputPort();
		this.rightOutputPort_1.setMaxFanOut(5);
		this.rightOutputPort_1.setWorkflow(_5019);
		this.rightOutputPort_1.setName("rightOutputPort_1");
		this.addPort(this.rightOutputPort_1, this.width + 5, (this.height / 2)-20);
		...
		this.rightOutputPort_2 = new draw2d.MyOutputPort();
		this.rightOutputPort_2.setMaxFanOut(5);
		this.rightOutputPort_2.setWorkflow(_5019);
		this.rightOutputPort_2.setName("rightOutputPort_2");
		this.addPort(this.rightOutputPort_2, this.width + 5, (this.height / 2)+20);
		
		this.bottomOutputPort_2= new draw2d.MyOutputPort();
		this.bottomOutputPort_2.setMaxFanOut(5);
		this.bottomOutputPort_2.setWorkflow(_5019);
		this.bottomOutputPort_2.setName("bottomOutputPort_2");
		this.addPort(this.bottomOutputPort_2, (this.width/2)+20, this.height + 5);
		...
		this.bottomOutputPort_1 = new draw2d.MyOutputPort();
		this.bottomOutputPort_1.setMaxFanOut(5);
		this.bottomOutputPort_1.setWorkflow(_5019);
		this.bottomOutputPort_1.setName("bottomOutputPort_1");
		this.addPort(this.bottomOutputPort_1, (this.width/2)-20, this.height + 5);
		
		this.leftOutputPort_2 = new draw2d.MyOutputPort();
		this.leftOutputPort_2.setWorkflow(_5019);
		this.leftOutputPort_2.setName("leftOutputPort_2");
		this.addPort(this.leftOutputPort_2, -5, (this.height / 2)+20);
		...
		this.leftOutputPort_1 = new draw2d.MyOutputPort();
		this.leftOutputPort_1.setWorkflow(_5019);
		this.leftOutputPort_1.setName("leftOutputPort_1");
		this.addPort(this.leftOutputPort_1, -5, (this.height / 2)-20);
