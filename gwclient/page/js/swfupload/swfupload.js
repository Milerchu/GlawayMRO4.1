...
SWFUpload.prototype.replaceWithFlash = function () {
	...
	//tempParent.innerHTML = '<input type="button"/>';
...
SWFUpload.prototype.getFlashHTML = function () {
	...
	var flashHTML = "";
	flashHTML = flashHTML + '<object id="'+this.movieName+'" type="application/x-shockwave-flash" ';
	flashHTML = flashHTML + 'data="'+this.settings.flash_url+'" width="'+this.settings.button_width+'" ';
	//flashHTML = flashHTML + ' width="'+this.settings.button_width+'" ';
	flashHTML = flashHTML + 'height="'+this.settings.button_height+'" class="swfupload"> ';
	flashHTML = flashHTML + '<param name="wmode" value="'+ this.settings.button_window_mode +'" />';
	flashHTML = flashHTML + '<param name="movie" value="'+ this.settings.flash_url+'" />';
	flashHTML = flashHTML + '<param name="quality" value="high" />';
	flashHTML = flashHTML + '<param name="menu" value="false" />';
	flashHTML = flashHTML + '<param name="allowScriptAccess" value="always" />';
	flashHTML = flashHTML + '<param name="flashvars" value="' + this.getFlashVars() + '" />';
