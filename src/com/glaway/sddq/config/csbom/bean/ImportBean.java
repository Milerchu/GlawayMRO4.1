...
public class ImportBean extends AddDoclinkBean
{
        ...
        throws Exception
    {
        ...
        if (!StringUtil.isNull(ownerTable) && "ASSETCS".equals(ownerTable))
        {
        ...
        ClassNotFoundException
    {
        ...
        String impclass = "com.glaway.sddq.config.csbom.imp.ImportAssetCSIface";
        ...
        imprltset.setUserWhere("IFACENAME = 'CSBOMIMP' AND OBJECTNAME='ASSETCS'");
        imprltset.reset();
