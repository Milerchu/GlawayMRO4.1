 ...
 * @since  [产品/模块版本]
 */
public class StatusOk implements ActionCustomClass {
	@Override
	public void executeCustomAction(IJpo jpo, String parameter)
			throws MroException {
		// TODO Auto-generated method stub
		if (jpo != null) {
			jpo.setValue("status", "待审批",
			...
			if(!materborrowlineset.isEmpty()){
				for(int i=0;i<materborrowlineset.count();i++){
					...
					CommonInventory.OUTINVENTORY(lotnum, qty, BORROWSTOREROOM, itemnum, assetnum, tasknum);
					CommonInventory.ININVENTORY(lotnum, qty, RETURNSTOREROOM, itemnum, assetnum, tasknum);
