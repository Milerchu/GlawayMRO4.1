 ...
 * @since [产品/模块版本]
 */
public class CbMprAppBean extends AppBean {
	/**
	...
	public int ROUTEWF() throws Exception {
		...
		if (!mprlineset.isEmpty()) {
			...
			throw new AppException("mprline", "nomprline");
		}
		return super.ROUTEWF();
	}

	/* 20181013肖林宝注掉，将方法移动到领料单流程操作类MprClose中 */
	...
	// locbinitem.setValue("qty",
	// newqty,GWConstant.P_NOCHECK_NOACTION_NOVALIDAT);
	// locbinitemset.save();
	// }
	// }
	// }
