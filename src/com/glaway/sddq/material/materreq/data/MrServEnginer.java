 ...
 * @since [产品/模块版本]
 */
public class MrServEnginer implements RoleCustomClass {
	...
	public IJpoSet executeCustomRole(IJpo curjpo, String param)
		...
		String persons = "";
		// 获取部门编号
		String deptnum = curjpo.getString("CREATEBY.DEPT.DEPTNUM");
		// mdm组织id
		String mdm_deptid = curjpo.getString("CREATEBY.DEPT.MDM_DEPTID");
		// 青岛分公司、广州检修基地
